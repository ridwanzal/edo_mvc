        ...
        success: function (res) {
            ...
            for (i; i < res.data.length; i++) {
                ...
                if (i < limit) {
                    ...
                    let object = '<div class="col-lg-4 col-md-4 col-xs-6 col-sm-6 item container_mag2 animated fadeIn"><a href=' + img_uri + '><img src=' + img_uri + ' style="height:373px;margin-bottom:16px;border:1px solid #eee;background-size:cover;" class="img_insta"></a></div>';
                    elem.append(object);
                    showImage();
                }
            }
