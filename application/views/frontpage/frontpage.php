            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-xs-12 container_images_me">
                        <img alt="" height="" widht="249px" id="myimage" src="<?php echo base_url() ?>assets/img//me2.png"><br>
            ...
            <div class="container"> 
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3 col-xs-12">
                        <p class="medium_text"><span><img alt="" src="<?php echo base_url() ?>assets/img//programming2.png"></span>&nbsp;&nbsp;Web Development</p>
                    </div>
                    <div class="col-lg-3 col-md-3 col-xs-12">
                        <p class="medium_text"><span><img alt="" src="<?php echo base_url() ?>assets/img//programming2.png"></span>&nbsp;&nbsp;Android App Dev</p>
                    </div>
                    <div class="col-lg-3 col-md-3 col-xs-12">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-5 col-md-4 col-xs-12">
                        <input class="inputstyle" placeholder="Email" type="">
                    </div>
                    <div class="col-lg-5 col-md-4 col-xs-12">
                        <input class="inputstyle" placeholder="Name" type="">
                    </div>
                    <div class="col-lg-2 col-md-4 col-xs-12">
                        <input class="button1_small_black" type="button" value="Submit">
                    </div>
                </div>
            </div>
        </div>
